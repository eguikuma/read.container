---
layout: default
title: 代替コンテナランタイムと関連技術
---

# [appendix：代替コンテナランタイムと関連技術](#alternative-runtimes) {#alternative-runtimes}

## [はじめに](#introduction) {#introduction}

[02-oci-and-runtime](../../02-oci-and-runtime/) では、runc、containerd、Docker、Podman を学びました
...
## [コンテナランタイムの分類](#runtime-classification) {#runtime-classification}
...
| 互換性 | OCI Runtime Specification に準拠<br>runc の代替として使用可能 |
...
### [アプリケーションコンテナ vs OS コンテナ](#app-vs-os-container) {#app-vs-os-container}
...
| ---- | -------------------------------------------------------- |
| 目的 | OS コンテナの簡易実行 |
| 特徴 | systemd の一部として標準で利用可能<br>追加インストール不要 |
...
## [ランタイムの選択指針](#runtime-selection-guide) {#runtime-selection-guide}
...
- [crun - GitHub](https://github.com/containers/crun){:target="\_blank"}
  - C 言語実装の OCI ランタイム
...
- [gVisor](https://gvisor.dev/){:target="\_blank"}
  - ユーザー空間カーネルの公式サイト
...
- [Incus](https://linuxcontainers.org/incus/){:target="\_blank"}
  - LXD のフォークプロジェクト

<strong>systemd-nspawn</strong>

- [systemd-nspawn(1)](https://www.freedesktop.org/software/systemd/man/latest/systemd-nspawn.html){:target="\_blank"}
  - systemd-nspawn のマニュアル

<strong>nerdctl</strong>

- [nerdctl - GitHub](https://github.com/containerd/nerdctl){:target="\_blank"}
