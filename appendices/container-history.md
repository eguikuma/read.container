...
[01-container](../01-container.md) では、コンテナが namespace と cgroup を使った「隔離されたプロセス」であることを学びました
...
| 2004 | Solaris Zones | Solaris | OS レベルの仮想化。ゾーンごとに独立した環境を提供                          |
...
## Linux の namespace と cgroup（2002〜2013）
...
| 機能         | 説明                                                      |
| ------------ | --------------------------------------------------------- |
| イメージ     | レイヤ構造のイメージ形式。Dockerfile による宣言的なビルド |
