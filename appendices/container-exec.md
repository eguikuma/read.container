...
# appendix：コンテナへの接続の仕組み

## はじめに

[01-container](../01-container.md) では、namespace がプロセスの見える範囲を制限することを学びました
...
[02-oci-and-runtime](../02-oci-and-runtime.md) で学んだように、Docker CLI → dockerd → containerd → runc というランタイムの階層構造がここでも使われています
...
[multi-stage-build](./multi-stage-build.md) で学んだ distroless イメージにはシェルすら含まれていません
